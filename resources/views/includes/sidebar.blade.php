        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    <li><a><i class="fa fa-level-up"></i> Quản trị Level<span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="{{ URL::to('level') }}">Level</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a><i class="fa fa-question"></i> Quản trị bài test<span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="{{ URL::to('exam_kit') }}">Bộ đề</a></li>
                        </ul>
                    </li>
                    {{--<li>--}}
